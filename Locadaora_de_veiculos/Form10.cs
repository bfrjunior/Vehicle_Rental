...
namespace Locadaora_de_veiculos
{
    public partial class Form10 : Form
    {
        ...
        private void tab_USADOS_carroBindingNavigatorSaveItem_Click(object sender, EventArgs e)
        {
            this.Validate();
            this.tab_USADOS_carroBindingSource.EndEdit();
        ...
        {
            // TODO: esta linha de código carrega dados na tabela 'bDDataSet.Tab_USADOS_carro'. Você pode movê-la ou removê-la conforme necessário.
            this.tab_USADOS_carroTableAdapter.Fill(this.bDDataSet.Tab_USADOS_carro);
