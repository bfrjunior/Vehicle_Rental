...
namespace Locadaora_de_veiculos
{
    public partial class Form7 : Form
    {
        ...
        private void tab_LOCACAO_carroBindingNavigatorSaveItem_Click(object sender, EventArgs e)
        {
            this.Validate();
            this.tab_LOCACAO_carroBindingSource.EndEdit();
        ...
        {
            // TODO: esta linha de código carrega dados na tabela 'bDDataSet.Tab_LOCACAO_carro'. Você pode movê-la ou removê-la conforme necessário.
            this.tab_LOCACAO_carroTableAdapter.Fill(this.bDDataSet.Tab_LOCACAO_carro);
